...
\begin{frame}{Discrimination of classical states}
Discrimination of \emm{classical} states:

\vspace{2em}
\begin{itemize}
\setlength{\itemsep}{2em}
\item Input: A \emm{classical} state $p_0$ is given with probability $\lambda$, and $p_1$ is given with probability $1-\lambda$.
\item Output: $i\in\{0,1\}$ that indicates the given state $p_i$.
\end{itemize}
\end{frame}

\begin{frame}{Maximum probability of success: Discrimination of classical states}
\small
\begin{theorem}
